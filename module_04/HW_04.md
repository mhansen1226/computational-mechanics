...
for i, x in enumerate(x):
    print("{:3.0f} {:3.0f} {:3.0f} | {:>7.2f}".format(*np.eye(3)[i], x))
```
...
x = np.linalg.solve(A, b(1000))
for i, x in enumerate(x):
    print("{:3.0f} {:3.0f} {:3.0f} {:3.0f} {:3.0f} {:3.0f} | {:>8.2f}".format(*np.eye(6)[i], x))
```
